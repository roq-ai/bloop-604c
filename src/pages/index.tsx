  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to BLOOP, your local 10-second video E-commerce platform. Discover and buy a myriad of new and used items including gadgets, furniture, art, and more. Transforming shopping in your city!"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1592503254549-d83d24a4dfab?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxlLWNvbW1lcmNlfGVufDB8fHx8MTY5Mzk3NjE5MHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@markkoenig?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Mark König`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to BLOOP, your local 10-second video E-commerce platform. Discover and buy a myriad of new and used items including gadgets, furniture, art, and more. Transforming shopping in your city!`}
            </Text>
            <Box
