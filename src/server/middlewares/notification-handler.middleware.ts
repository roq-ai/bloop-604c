...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order.create': {
    roles: ['business-owner', 'sales-manager', 'customer-service-representative', 'inventory-manager'],
    key: 'new-customer-order',
    tenantPath: ['marketplace', 'item', 'order'],
    userPath: [],
  },
  'item.update': {
    roles: ['business-owner', 'sales-manager', 'customer-service-representative'],
    key: 'item-status-update',
    tenantPath: ['marketplace', 'item'],
    userPath: [],
  },
  'video.create': {
    roles: ['business-owner', 'sales-manager', 'customer-service-representative'],
    key: 'new-item-video',
    tenantPath: ['marketplace', 'item', 'video'],
    userPath: [],
  },
};
